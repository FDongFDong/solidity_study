...
export interface FixedMoonVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "deposit"
      | "getBalance"
...
export interface FixedMoonVault extends BaseContract {
  connect(runner?: ContractRunner | null): FixedMoonVault;
  waitForDeployment(): Promise<this>;

  interface: FixedMoonVaultInterface;
